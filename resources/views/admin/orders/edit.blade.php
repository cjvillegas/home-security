    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_ord_ref') ? 'is-invalid' : '' }}" type="text" name="cust_ord_ref" id="cust_ord_ref" value="{{ old('cust_ord_ref', $order->cust_ord_ref) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_ord_no') ? 'is-invalid' : '' }}" type="text" name="cust_ord_no" id="cust_ord_no" value="{{ old('cust_ord_no', $order->cust_ord_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blind_type') ? 'is-invalid' : '' }}" type="text" name="blind_type" id="blind_type" value="{{ old('blind_type', $order->blind_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('range') ? 'is-invalid' : '' }}" type="text" name="range" id="range" value="{{ old('range', $order->range) }}">
                @if($errors->has('range'))
                    <div class="invalid-feedback">
                        {{ $errors->first('range') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('colour') ? 'is-invalid' : '' }}" type="text" name="colour" id="colour" value="{{ old('colour', $order->colour) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_code') ? 'is-invalid' : '' }}" type="text" name="stock_code" id="stock_code" value="{{ old('stock_code', $order->stock_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('man_width') ? 'is-invalid' : '' }}" type="text" name="man_width" id="man_width" value="{{ old('man_width', $order->man_width) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('man_drop') ? 'is-invalid' : '' }}" type="text" name="man_drop" id="man_drop" value="{{ old('man_drop', $order->man_drop) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blind_status') ? 'is-invalid' : '' }}" type="text" name="blind_status" id="blind_status" value="{{ old('blind_status', $order->blind_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('despatch_date') ? 'is-invalid' : '' }}" type="text" name="despatch_date" id="despatch_date" value="{{ old('despatch_date', $order->despatch_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('ordered') ? 'is-invalid' : '' }}" type="text" name="ordered" id="ordered" value="{{ old('ordered', $order->ordered) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('required') ? 'is-invalid' : '' }}" type="text" name="required" id="required" value="{{ old('required', $order->required) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('scheduled_date') ? 'is-invalid' : '' }}" type="text" name="scheduled_date" id="scheduled_date" value="{{ old('scheduled_date', $order->scheduled_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('roller_table') ? 'is-invalid' : '' }}" type="text" name="roller_table" id="roller_table" value="{{ old('roller_table', $order->roller_table) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remake') ? 'is-invalid' : '' }}" type="text" name="remake" id="remake" value="{{ old('remake', $order->remake) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('same_day_despatch') ? 'is-invalid' : '' }}" type="text" name="same_day_despatch" id="same_day_despatch" value="{{ old('same_day_despatch', $order->same_day_despatch) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('over_size') ? 'is-invalid' : '' }}" type="text" name="over_size" id="over_size" value="{{ old('over_size', $order->over_size) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('man_location') ? 'is-invalid' : '' }}" type="text" name="man_location" id="man_location" value="{{ old('man_location', $order->man_location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_entered_by') ? 'is-invalid' : '' }}" type="text" name="order_entered_by" id="order_entered_by" value="{{ old('order_entered_by', $order->order_entered_by) }}">
